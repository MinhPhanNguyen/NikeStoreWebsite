...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const span = document.querySelector(".CartPage .Container .Section_1 .Contain .TableItems .Items .ItemsFeature .btn span");
    const minus = document.querySelector(".CartPage .Container .Section_1 .Contain .TableItems .Items .ItemsFeature .btn .Minus");
    const plus = document.querySelector(".CartPage .Container .Section_1 .Contain .TableItems .Items .ItemsFeature .btn .Plus");
    const trash = document.querySelector(".CartPage .Container .Section_1 .Contain .TableItems .Items .ItemsFeature .btn .Trash");
    const favourButtons = document.querySelectorAll('.CartPage .Container .Section_1 .Contain .TableItems .Items .ItemsFeature .btnFavour');
    const favour = document.querySelector(".CartPage .Container .Section_1 .Contain .TableItems .Items .ItemsFeature .btnFavour i");

    if (span && minus && plus && trash && favour) {
        const updateIcons = () => {
