...
{
    /// <inheritdoc />
    public partial class seddPromo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductGender", x => x.GenderID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payment_Account_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Importing", x => x.ImportID);
                    table.ForeignKey(
                        name: "FK_Importing_Provider_ProviderID",
                        column: x => x.ProviderID,
                        principalTable: "Provider",
                        principalColumn: "ProviderID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Importing_Warehouse_WarehouseID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Product_ProductGender_GenderID",
                        column: x => x.GenderID,
            ...
            migrationBuilder.CreateTable(
                name: "ImportingDetail",
                columns: table => new
                {
                    ImportDetailID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ImportID = table.Column<int>(type: "int", nullable: false),
                    ImportingImportID = table.Column<int>(type: "int", nullable: true),
                    ProductID = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportingDetail", x => x.ImportDetailID);
                    table.ForeignKey(
                        name: "FK_ImportingDetail_Importing_ImportingImportID",
                        column: x => x.ImportingImportID,
                        principalTable: "Importing",
                        principalColumn: "ImportID");
                    table.ForeignKey(
                        name: "FK_ImportingDetail_Product_ProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Importing_ProviderID",
                table: "Importing",
                column: "ProviderID");

            migrationBuilder.CreateIndex(
                name: "IX_Importing_WarehouseID",
                table: "Importing",
                column: "WarehouseID");

            migrationBuilder.CreateIndex(
                name: "IX_ImportingDetail_ImportingImportID",
                table: "ImportingDetail",
                column: "ImportingImportID");

            migrationBuilder.CreateIndex(
                name: "IX_ImportingDetail_ProductID",
                table: "ImportingDetail",
                column: "ProductID");
